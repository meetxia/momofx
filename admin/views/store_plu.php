                    ...
                    <div class="card mb-4 shadow-sm">
                        ...
                        <div class="card-body">
                            <p class="card-text font-weight-bold">
                                ...
                                <?php if ($v['svip']): ?>
                                    <a href="https://www.emlog.net.cn/register" class="badge badge-warning p-1" target="_blank">铁杆专属</a>
                                <?php endif; ?>
                            </p>
                            ...
                            <div class="card-text d-flex justify-content-between">
                                ...
                                <div>
                                    <?php if ($v['price'] > 0): ?>
                                        ...
                                        <?php else: ?>
                                            <a href="https://www.emlog.net.cn/order/submit/plugin/<?= $v['id'] ?>" class="btn btn-danger" target="_blank">立即购买</a>
                                        <?php endif ?>
                                    <?php else: ?>
